          ...
          <div className="container flex flex-wrap justify-between items-center mx-auto">
              ...
              <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-4">
                  <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                      ...
                      <li>
                          <Link to="/about" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:text-blue-700 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">About</Link>
                      </li>
                      <li>
      ...
      <main className="mt-12 lg:mt-32">
              <section className="container mx-auto px-6">
                  <div className="w-full lg:flex items-center">
                      <div className="w-full lg:w-1/2">
                          <h2 className="text-3xl lg:text-3xl font-bold text-gray-600 mb-2 lg:mb-6">Oyenola Philip</h2>
                          <p className="text-md lg:text-xl font-light text-gray-800 mb-8">Founder and CEO of Frivacy. A Full stack programmer and App developer. He is passionate about solving online privacy </p>
                      </div>
                      <div className="w-full lg:w-1/2 lg:pl-24">
                          <img className="rounded-l-lg h-80 w-80" src="https://www.nairaland.com/attachments/14320582_philip_jpegd46dad9cdf28e572fda9bfb225cd96e2" alt="nice img"/>
                      </div>
                  </div>
                </section>
            </main>
            <main className="mt-12 lg:mt-32">
              <section className="container mx-auto px-6">
                  <div className="w-full lg:flex items-center">
                      <div className="w-full lg:w-1/2">
                          <h2 className="text-3xl lg:text-3xl font-bold text-gray-600 mb-2 lg:mb-6">Oyenola Marvellous</h2>
                          <p className="text-md lg:text-xl font-light text-gray-800 mb-8">A young programmer and digital marketer.</p>
                      </div>
                      <div className="w-full lg:w-1/2 lg:pl-24">
                          <img className="rounded-l-lg h-80 w-80" src="https://pirel.tk/marvellous.jpg" alt="nice img"/>
                      </div>
                  </div>
                </section>
            </main>
